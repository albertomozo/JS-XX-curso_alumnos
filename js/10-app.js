...
info.innerHTML += `<li>filter(): Este método busca el primer elemento en un array que cumple una condición especificada en una función de prueba. Devuelve el indice del primer elemento que cumple la condición, o undefined si no se encuentra ningún elemento que cumpla la condición.</li>`;
...
console.log(array1, array1.lastIndexOf(3)); // muestra 4
